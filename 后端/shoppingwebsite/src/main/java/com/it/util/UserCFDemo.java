...
public class UserCFDemo{
    ...
    //和这些用户相关的美食
    public static String[] movies={"美食1","美食2","美食3","美食4","美食5","美食6","美食7"};
    //用户点评美食打星数据,是users对应用户针对movies对应美食的评分
...
//    	System.out.println("realname=="+realname);
    ...
    private static void calcRecommendMovie(){
        ...
        for (List<Object> item:recommendMovies){
            if(Double.parseDouble(item.get(1).toString()) > sumRate/mvnum){ //大于平均推荐度的美食才有可能被推荐
