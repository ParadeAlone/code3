...
public class UtilController {
    ...
    public Map uploadImg2(MultipartFile file, HttpServletRequest request) {
        String prefix = "";
        String dateStr = "";
        //保存上传
        OutputStream out = null;
        ...
        try {
            if (file != null) {
                ...
                map2.put("url",  "http://127.0.0.1:8088/shoppingwebsite/upload/"+uuid + "." + prefix);
                map2.put("alt",  "");
                map2.put("href",  "");
    ...
    public Map uploadImg1(MultipartFile file, HttpServletRequest request) {
        String prefix = "";
        String dateStr = "";
        //保存上传
        OutputStream out = null;
