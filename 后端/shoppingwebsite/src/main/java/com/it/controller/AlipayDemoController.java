...
public class AlipayDemoController {
    ...
    public String view(HttpServletRequest request) {
        String id = (String) request.getSession().getAttribute("order_id");
        request.getSession().removeAttribute("order_id");
        TOrder tOrder = tOrderService.selectById(Integer.parseInt(id));
        tOrder.setStatus("待发货");
        tOrderService.update(tOrder);
        return "redirect:http://127.0.0.1:9090/member/tOrderList";
    }
    ...
    public String view1(HttpServletRequest request) {
        ...
        return "redirect:http://127.0.0.1:9090/member/doctorDetail?id="+doctorid;
    }
