          ...
          <div class="row align-items-center">
            <div class="col-md-12">
              ...
              <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="javascript:void(0)" v-html="formTitle==='save'?'分类新增':'分类编辑'"  ></a></li>
              </ul>
            </div>
          </div>
        </div>
            ...
            <div class="card">
               <el-form ref="category" :rules="rules" :model="category" label-width="80px">
                  <el-form-item prop="name" label="名称">
                      <el-input v-model="category.name" placeholder="名称"></el-input>
                  </el-form-item>
                  <el-form-item>
...
export default {
    ...
    created(){
        ...
        this.load()
        this.category.fatherid = this.$route.query.fatherid
    },
    methods: {
        async load(){
            if(this.$route.query.id!==undefined){
                this.formTitle = 'update'
                let {data : res} = await this.$http.post('category/get',this.qs.stringify({
