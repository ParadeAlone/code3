            ...
            <div class="card">
               <el-form ref="news" :rules="rules" :model="news" label-width="80px">
                ...
                <el-form-item prop="content" label="内容">
                    <my-editor :content="news.content" @getContent="getContent"></my-editor>
                </el-form-item>
    ...
    methods: {
        ...
        async load(){
            if(this.$route.query.id!==undefined){
                ...
                this.news = res.data
                this.imageUrl = this.baseURL + '/upload/' + this.news.filename
            }
        },
        onSubmit() {
            this.$refs.news.validate(async (valid) => {
                if (valid) {
                    ...
                    await this.$router.push('newsList')
                }
            })
        },
        ...
        handleAvatarSuccess(res, file) {
            ...
            this.news.filename = res.data.src
        },
